...
/* region Getters */
double BBox::getMinX() const { return mMinX; }

double BBox::getMinY() const { return mMinY; }

double BBox::getMaxX() const { return mMaxX; }

double BBox::getMaxY() const { return mMaxY; }

/* endregion */

/* region Setters */
void BBox::setMinX(double v) { mMinX = v; }

void BBox::setMinY(double v) { mMinY = v; }

void BBox::setMaxX(double v) { mMaxX = v; }

void BBox::setMaxY(double v) { mMaxY = v; }
/* endregion */
